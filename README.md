...
THIS SOFTWARE IS PROVIDED "AS IS" AND "AS AVAILABLE," WITHOUT WARRANTY OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, ACCURACY, RELIABILITY, COMPATIBILITY, OR NON-INFRINGEMENT.

THIS SOFTWARE PERFORMS SYSTEM-LEVEL OPERATIONS THAT MAY MODIFY DISKS, PARTITIONS, FILESYSTEMS, BOOTLOADERS, SYSTEM CONFIGURATION, INSTALLED PACKAGES, NETWORK SETTINGS, AND OTHER COMPONENTS OF A COMPUTER SYSTEM. IMPROPER CONFIGURATION, UNEXPECTED HARDWARE OR SOFTWARE CONDITIONS, USER ERROR, SOFTWARE DEFECTS, OR MODIFICATION OF THIS SOFTWARE MAY RESULT IN DATA LOSS, SYSTEM CORRUPTION, LOSS OF BOOTABILITY, HARDWARE OR SOFTWARE MALFUNCTION, OR OTHER DAMAGE.

YOU ARE SOLELY RESPONSIBLE FOR REVIEWING AND UNDERSTANDING THE SOURCE CODE, CONFIGURATION, COMMANDS, AND OPERATIONS PERFORMED BY THIS SOFTWARE BEFORE EXECUTING IT. You are responsible for determining whether this software is appropriate for your system and intended use and for maintaining complete and verified backups of any data you consider important.

By downloading, executing, modifying, distributing, or otherwise using this software, you acknowledge and voluntarily assume all risks associated with its use.

TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, THE AUTHOR, CONTRIBUTORS, COPYRIGHT HOLDERS, AND DISTRIBUTORS OF THIS SOFTWARE SHALL NOT BE LIABLE FOR ANY DIRECT, INDIRECT, INCIDENTAL, SPECIAL, EXEMPLARY, CONSEQUENTIAL, OR OTHER DAMAGES OR LOSSES ARISING FROM OR RELATED TO THE USE, MISUSE, INABILITY TO USE, MODIFICATION, OR DISTRIBUTION OF THIS SOFTWARE, INCLUDING, WITHOUT LIMITATION, LOSS OF DATA, LOSS OF PROFITS, LOSS OF BUSINESS, SYSTEM DOWNTIME, SYSTEM CORRUPTION, HARDWARE OR SOFTWARE DAMAGE, OR COSTS ASSOCIATED WITH RECOVERY, REPAIR, OR REPLACEMENT.

IF YOU DO NOT UNDERSTAND WHAT THIS SOFTWARE DOES, HAVE NOT REVIEWED ITS SOURCE CODE, OR ARE NOT PREPARED TO ACCEPT THE RISKS ASSOCIATED WITH ITS OPERATION, DO NOT EXECUTE IT.
